  ...
  <div class="page">
    ...
    <div class="goods-main">
      <div ref="scroll-classify" class="classify-wrap">
        <div>
          <div ref="item" :class="{ 'classify-item': true, active: item.active }" v-for="(item, index) in classifys" :key="index" @click="replacePage('/goods/classify/item?cid=' + item.cid, index)">
            {{ item.title }}
          </div>
        </div>
      </div>
...
MySearch
  ...
  beforeDestroy() {
    // console.log(this.$refs['scroll-classify']);
