      ...
      <div class="goods-main" :key="index" v-if="(index + 1) % 2 !== 0">
        ...
        <div class="goods-row-1">
          <div class="goods-column">
            ...
            <div :class="'goods-price bg-color-' + index">
          ...
          <div class="goods-column">
            <div class="goods-list" v-for="(item2, index2) in item.items.slice(1, 3)" :key="index2">
              ...
              <div class="goods-list-image">
                <img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item2.image" alt="item2.image" />
              </div>
            </div>
          </div>
        </div>
...
.header.scroll {
  background: linear-gradient(#eb6125, hsla(0, 0%, 100%, 0));
}
